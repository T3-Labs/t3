...
class TestConfigManager:
    ...
    def test_load_config_valid_file(self, mock_open_file: Mock, mock_exists: Mock) -> None:
    ...
    @patch('pathlib.Path.exists')
    @patch('pathlib.Path.open')
    def test_load_config_invalid_json(self, mock_open_file: Mock, mock_exists: Mock) -> None:
